...
//This function organizes the other functions in way that it passes the contents of above array (episodes / mrn's) to the functions defined.
...
//This function launches Puppeteer and logs into the NHLS proxy.
async function launchpuppeteer(allEpisodes){
    ...
    newData=[]
    //This is a for...of loop to loop through all the episodes.
    for(let episode of allEpisodes){
        console.log(episode);
        async function getDataOnPage(episode){
            url = 'http://trakdb-prod.nhls.ac.za:57772/csp/reporting/eprajax.csp?chunk=' + episode + '%5EA030%5E1%5ET%5E'
    ...
    //console.log(newData)
    //After the loop is done, it will write the contents scraped to an Excel file.
